...
('Reclaim the Deadmines', 'The defector Edwin VanCleef has fortified the old Deadmines and is building a fleet to strike at Stormwind itself. Descend into the mines, defeat VanCleef, and put an end to his plot for good.', 'MEDIUM', 10, 220, 280, 'AVAILABLE'),
...
('Break the Siege of Darkshire', 'Undead forces pouring out of the Raven Hill Cemetery threaten to overrun Darkshire entirely, and the town guard is stretched thin. Break the siege before the last watchfire in Duskwood goes dark.', 'HARD', 24, 420, 520, 'AVAILABLE'),
...
('Slay Onyxia', 'The black dragon Onyxia has spent years infiltrating Stormwind in disguise, whispering poison into the ears of the court. Expose her, drag her back to her lair beneath the Dragonmurk, and end her scheming for good.', 'EPIC', 38, 1350, 800, 'AVAILABLE'),
